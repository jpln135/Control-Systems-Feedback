...
It is represented in a Feedback Block Diagram as follows
\begin{figure}[!ht]
	\begin{center}
		\resizebox{\columnwidth}{!}{\input{figs/ee18btech11021/Shunt_Series_Block_Diagram.tex}}
	\end{center}
\caption{Shunt Series Amplifier Block Diagram}
\label{fig:Shunt_Series_Block_Diagram}
\end{figure}
...
\item
Draw the Block Diagram for the Gain Block, with the corresponding Circuit.

\solution
\begin{figure}[!ht]
	\begin{center}
		\resizebox{\columnwidth}{!}{\input{figs/ee18btech11021/Gain_Block.tex}}
	\end{center}
\caption{Gain Block}
...
\label{fig:Gain_Circuit}
\end{figure}

\item
Calculate $R_{11}$ and use it to find the Gain G.

\solution
$R_{11}$ is the resistance in parallel with the Resistance of the Source and the Input Impedance of the Opamp
\begin{align}
    R_{11} = R_{1} + R_{2}
\end{align}
...
\item
Draw the Block Diagram for the Feedback Block, with the corresponding Circuit.

\solution
\begin{figure}[!ht]
	\begin{center}
		\resizebox{\columnwidth}{!}{\input{figs/ee18btech11021/Feedback_Block.tex}}
	\end{center}
...
\begin{figure}[!ht]
	\begin{center}
		\resizebox{\columnwidth}{!}{\input{figs/ee18btech11021/Feedback_Circuit.tex}}
	\end{center}
...
\item
Calculate $R_{22}$ and use it to find the Feedback Gain H.
\solution
